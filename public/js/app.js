...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  filters: {
    ago: function ago(date) {
      return luxon__WEBPACK_IMPORTED_MODULE_0__["DateTime"].fromISO(date).setLocale('co').toLocaleString(luxon__WEBPACK_IMPORTED_MODULE_0__["DateTime"].DATETIME_FULL);
    }
  },
  created: function created() {
    var _this = this;

    _models_Status__WEBPACK_IMPORTED_MODULE_1__["default"].all().then(function (_ref) {
      var data = _ref.data;
